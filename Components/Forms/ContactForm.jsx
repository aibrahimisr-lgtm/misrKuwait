      ...
      <form className="space-y-8 relative z-10" style={{ opacity: 1 }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-3">
            <label
              htmlFor="name"
              className="peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-white/80 font-bold text-md sm:text-lg"
            >
              الاسم بالكامل
            </label>
            <input
          ...
          <div className="space-y-3">
            <label
              htmlFor="phone"
              className="peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-md sm:text-lg text-white/80 font-bold"
            >
              رقم الهاتف
            </label>
            <input
        ...
        <button
          className="bg-white text-primiary rounded-4xl w-full text-lg sm:text-2xl justify-center items-center font-bold py-3 px-8 sm:py-6 sm:px-10 flex gap-2"
          type="submit"
        >
          إرسال الرسالة الآن
          <Send size={20} />
